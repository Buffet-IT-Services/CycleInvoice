...
class TestSubscription(TestCase):
    ...
    def test_subscription_extension_block_cancelled(self) -> None:
        ...
        with self.assertRaises(SubscriptionExtensionError):
            subscription_extension(subscription=self.subscription_cancelled, user=get_system_user())
    ...
    def test_subscription_extension_creates_correct(self) -> None:
        ...
        subscription_extension(subscription=self.subscription, user=get_system_user())
    ...
    def test_subscription_extension_no_user(self) -> None:
        ...
        with self.assertRaises(ValueError):
            subscription_extension(subscription=self.subscription, user=None)
    ...
    def test_subscription_extension_invalid_subscription(self) -> None:
        ...
        with self.assertRaises(ValueError):
            subscription_extension(subscription=999999, user=get_system_user())
